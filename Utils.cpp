...
/***************************************************************
*                                                             *
*           Reading unsigned long parameter from string                *
*                                                             *
*    Input parameters:                                        *
*                      char *param_str - buffer with record   *
*    Output parameter:                                        *
...
*                                                             *
***************************************************************/
int ReadUnsignedLongParam(char *param_str, unsigned long *param)
{
	if (!*param_str) return -1;
...
/***************************************************************
*                                                             *
*           Reading unsigned long long parameter from string                *
*                                                             *
*    Input parameters : *
*                      char *param_str - buffer with record   *
*    Output parameter : *
*                      unsigned long long *param - parameter                *
*                                                             *
*    Return value : *
*                   int - 0 - sucsess                        *
*                         -1 - error                          *
*                                                             *
***************************************************************/
int ReadUnsignedLongLongParam(char *param_str, unsigned long long *param)
{
	if (!*param_str) return -1;
	if (!sscanf(param_str, "%llu", param)) return -1;
	return 0;
}
...
//        { pref = NULL; continue;}
 ...
 void DateTime( char *date, char *time)
 {
  ...
  GetLocalTime( &ts);
  if(date)
   sprintf(date,"%d.%d.%d",ts.wDay, ts.wMonth, ts.wYear);
  if(time)
   sprintf(time,"%d:%d:%d", ts.wHour, ts.wMinute,ts.wSecond );
 }
